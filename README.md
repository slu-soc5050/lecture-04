lecture-04 <img src="https://slu-soc5050.github.io/images/logo.png" align="right" />
===========================================================
[![](https://img.shields.io/badge/semester-fall%202018-yellow.svg)](https://github.com/slu-soc5050/lecture-04)
[![](https://img.shields.io/badge/release-draft-red.svg)](https://github.com/slu-soc5050/lecture-04)
[![](https://img.shields.io/github/release/slu-soc5050/lecture-04.svg?label=version)](https://github.com/slu-soc5050/lecture-04/releases)
[![](https://img.shields.io/github/last-commit/slu-soc5050/lecture-04.svg)](https://github.com/slu-soc5050/lecture-04/commits/master)
[![](https://img.shields.io/github/repo-size/slu-soc5050/lecture-04.svg)](https://github.com/slu-soc5050/lecture-04)
[![Travis-CI Build Status](https://travis-ci.org/slu-soc5050/lecture-04.svg?branch=master)](https://travis-ci.org/slu-soc5050/lecture-04)
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/slu-soc5050/lecture-04?branch=master&svg=true)](https://ci.appveyor.com/project/chris-prener/lecture-04)

This is the repository for Lecture 01 of the Saint Louis University course SOC 4015/5050 - Quantitative Analysis. This lecture introduces core concepts related to probability as well as the logic behind Bayes' Theorem.
...
* The [lecture webpage](https://slu-soc5050.github.io/lecture-04) contains links to resources as well the lecture slides
...
```r
usethis::use_course("https://github.com/slu-soc5050/lecture-04/archive/master.zip")
```
